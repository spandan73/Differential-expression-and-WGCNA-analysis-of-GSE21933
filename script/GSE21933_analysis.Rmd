...
heatmap_cor <- labeledHeatmap(Matrix = moduleTraitCor,
...
png(filename = "../figure/WGCNA_ModuleCorr.png",width = 20, height = 10, units = "in")
ggsave(heatmap_cor, filename="WGCNA_ModuleCorrelation.png", path = "../figures", dpi = 600, width = 20, height = 10, units = "in" )
...
kWithin <- intramodularConnectivity(adjacency_mat, dynamicColors)
