...
mean_control <- data.frame(mean_control)%>%rownames_to_column(var = "control")
...
library(WGCNA) #two dependencies were missing, BiocManager::install("preprocessCore"), BiocManager::install("preprocessCore")

gsg <- goodSamplesGenes(t(exprs_data))
