...
MEs <- moduleEigengenes(adj_matrix, colors = dynamicColors, softPower = softPower)$eigengenes
MEs <- orderMEs(MEs)

saveRDS(file = "adjency.rds", object = adjacency_mat)
saveRDS(file = "TOM.rds", object = TOM)
saveRDS(file = "MEs.rds", object = MEs)
